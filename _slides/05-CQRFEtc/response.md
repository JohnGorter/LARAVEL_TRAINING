...
> Did you know you can also return Eloquent collections from your routes or 
...
You may also return Eloquent ORM models and collections directly from your routes and controllers. When you do, Laravel will automatically convert the models and collections to JSON responses 
```
use App\Models\User;
...
- specify the column in the route parameter definition (/profile/{id:slug}) 
- override the getRouteKey method on your model
...
Several helpful methods for generating responses follow..
--
